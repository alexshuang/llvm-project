//===-- RISCXAsmBackend.h - RISCX Assembler Backend -----------------------===//
//
...
public:
  RISCXAsmBackend(const MCSubtargetInfo &STI, uint8_t OSABI, bool Is64Bit,
                  const MCTargetOptions &Options)
      : MCAsmBackend(support::little), STI(STI), OSABI(OSABI), Is64Bit(Is64Bit),
        TargetOptions(Options) {
    TargetABI = RISCXABI::computeTargetABI(
        STI.getTargetTriple(), STI.getFeatureBits(), Options.getABIName());
    RISCXFeatures::validate(STI.getTargetTriple(), STI.getFeatureBits());
  }
  ~RISCXAsmBackend() override {}
  ...
  bool willForceRelocations() const {
    return ForceRelocs || STI.getFeatureBits()[RISCX::FeatureRelax];
  }
  ...
  unsigned getNumFixupKinds() const override {
    return RISCX::NumTargetFixupKinds;
  }
  ...
  const MCFixupKindInfo &getFixupKindInfo(MCFixupKind Kind) const override {
    const static MCFixupKindInfo Infos[] = {
      ...
      { "fixup_riscx_pcrel_hi20",   12,     20,
        MCFixupKindInfo::FKF_IsPCRel | MCFixupKindInfo::FKF_IsTarget },
      { "fixup_riscx_pcrel_lo12_i", 20,     12,
        MCFixupKindInfo::FKF_IsPCRel | MCFixupKindInfo::FKF_IsTarget },
      { "fixup_riscx_pcrel_lo12_s",  0,     32,
        MCFixupKindInfo::FKF_IsPCRel | MCFixupKindInfo::FKF_IsTarget },
      { "fixup_riscx_got_hi20",     12,     20,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_tprel_hi20",   12,     20,  0 },
      { "fixup_riscx_tprel_lo12_i", 20,     12,  0 },
      { "fixup_riscx_tprel_lo12_s",  0,     32,  0 },
      { "fixup_riscx_tprel_add",     0,      0,  0 },
      { "fixup_riscx_tls_got_hi20", 12,     20,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_tls_gd_hi20",  12,     20,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_jal",          12,     20,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_branch",        0,     32,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_rvc_jump",      2,     11,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_rvc_branch",    0,     16,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_call",          0,     64,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_call_plt",      0,     64,  MCFixupKindInfo::FKF_IsPCRel },
      { "fixup_riscx_relax",         0,      0,  0 },
      { "fixup_riscx_align",         0,      0,  0 }
    };
    static_assert((array_lengthof(Infos)) == RISCX::NumTargetFixupKinds,
