//===-- RISCXTargetMachine.h - Define TargetMachine for RISCX ---*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the RISCX specific subclass of TargetMachine.
//
//===----------------------------------------------------------------------===//
...
class RISCXTargetMachine : public LLVMTargetMachine {
  ...
  mutable StringMap<std::unique_ptr<RISCXSubtarget>> SubtargetMap;
...
public:
  ...
  const RISCXSubtarget *getSubtargetImpl() const = delete;
