//===-- RISCXTargetObjectFile.cpp - RISCX Object Info -----------------===//
//
...
void RISCXELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool RISCXELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool RISCXELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *RISCXELFTargetObjectFile::SelectSectionForGlobal(
...
void RISCXELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool RISCXELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *RISCXELFTargetObjectFile::getSectionForConstant(
